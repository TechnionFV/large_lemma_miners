...
module main(clk, rst, input_stream,stream_end);
  ...
  // initial clk=0;
   ...
   input_buffer          mod1(rst,clk,input_stream,buffer);
   counter               mod2(rst,clk,read_enable);
   fsm_for_pack_start    mod3(rst,buffer,packHeadStart,clk,packHeadStop);
   parse_pack_header     mod4(rst,buffer,packParseStart,read_enable,packParseStop,scr,muxRate);
   fsm_for_syshead_start mod5(rst,buffer,sysHeadStart,read_enable,sysHeadStop);
   parse_system_header   mod6(rst,buffer,sysHeadParseStart,read_enable,sysHeadParseStop,sysHeadLen,rateBnd,flagInfo,resvdByte);
   read_packet           mod7(rst,packetStart,packetStop,buffer,read_enable,data_buffer,stream_end);
 ...
 *
 */
module input_buffer (rst, clk,input_stream,output_buffer);
...
module counter (rst, clk,count_over);
...
module fsm_for_pack_start(rst, one_byte,start,enable,stop);
...
module parse_pack_header(rst, one_byte,start,enable,stop,scr_reg,mux_rate_reg);
...
module fsm_for_syshead_start(rst, one_byte,start,enable,stop);
...
module parse_system_header(rst, one_byte,start,enable,stop,syshead_len_reg,rate_bnd_reg,flag_reg,resvd_byte_reg);
...
module read_packet (rst, start,done,input_stream,read_signal,buffer_out,stream_done);
...
start_code_prefix  module1(rst, start,prefix_stop,input_stream,read_signal);
//time_stamps        module2(rst, time_stamp_start,time_stamp_stop,input_stream,read_signal,timeStampBytes,timeStampFlag);
time_stamps        module2(rst, time_stamp_start,time_stamp_stop,input_stream,read_signal,timeStampBytes,timeStampFlag);
endmodule



module time_stamps(rst, start,done,input_stream,read_signal,timeBytes,flag);
...
module start_code_prefix(rst, start,done,input_stream,read_signal);
